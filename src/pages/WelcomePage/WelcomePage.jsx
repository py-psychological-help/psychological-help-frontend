		...
		<section className={cls.WelcomePageSection}>
			<div className={cls.container}>
				...
				<p className={cls.caption}>
					...
					чтобы&nbsp;справляться с&nbsp;трудностями и&nbsp;жить в&nbsp;гармонии с&nbsp;собой.
				</p>
				...
				<div className={cls.line}>
					...
					<p className={cls.lineText}>Возможность управления заявками и&nbsp;выбором тем</p>
				</div>

				<div className={cls.line}>
					<div className={`${cls.lineNumber} ${cls.icon2}`} />
					<p className={cls.lineText}>Инструмент для развития навыков</p>
				</div>

				<div className={cls.line}>
					<div className={`${cls.lineNumber} ${cls.icon3}`} />
					<p className={cls.lineText}>Возможность работать из&nbsp;любой точки мира в&nbsp;любое время</p>
				</div>

				<h3 className={cls.subSubTitle}>
					Для того, чтобы присоединиться к&nbsp;нашей команде психологов необходимо&nbsp;иметь
				</h3>
