			...
			<div className={styles.faqBlock}>
					...
					>
						{expanded1 ? (
							<p className={styles.faqAnswerText}>
								Психолог отвечает в&nbsp;рабочее время
								с&nbsp;10:00 до&nbsp;22:00 (мск), суббота
								и&nbsp;воскресенье&nbsp;&mdash; выходные. Обрати
								внимание, что иногда психолог отвечает
								не&nbsp;сразу, а&nbsp;с&nbsp;небольшой
								задержкой, несколько раз в&nbsp;день. Психолог
								обязательно ответит тебе в&nbsp;течение
								нескольких часов.
							</p>
						) : (
							''
				...
				<div className={styles.faqElement}>
					...
					>
						{expanded2 ? (
							<p className={styles.faqAnswerText}>
								Чаще всего так и&nbsp;бывает. Попробуй
								определить, какая из&nbsp;проблем волнует тебя
								больше всего. И&nbsp;именно её&nbsp;опиши
								наиболее подробно. По&nbsp;мере общения,
								появится возможность описать и&nbsp;остальные
								проблемы.
							</p>
						) : (
							''
						...
						>
							{expanded3 ? (
								<p className={styles.faqAnswerText}>
									...
									ответить сразу. Не&nbsp;расстраивайся,
									психолог обязательно ответит позже. Если
									ответ не&nbsp;пришёл в&nbsp;течении
									24&nbsp;часов, отправь заявку повторно.
									А&nbsp;если у&nbsp;тебя срочный вопрос,
									можешь позвонить на&nbsp;любую горячую линию
									(смотри выше).
								</p>
							) : (
								''
						...
						>
							{expanded4 ? (
								<p className={styles.faqAnswerText}>
									...
									не&nbsp;только с&nbsp;проблемами. Психолог
									может помочь, когда ты&nbsp;знаешь, чего
									хочешь, и&nbsp;тебе нужно узнать, как этого
									достичь. К&nbsp;психологу обращаются
									с&nbsp;целью самопознания или саморазвития,
									когда ты&nbsp;готов меняться
									и&nbsp;двигаться дальше. Психолог, подскажет
									как обрести гармонию и&nbsp;улучшить
									ментальное здоровье.
								</p>
							) : (
								''
					...
					<div className={styles.faqElement}>
						...
						>
							{expanded5 ? (
								<p className={styles.faqAnswerText}>
									Все, что ты&nbsp;пишешь&nbsp;&mdash;
									анонимно и&nbsp;конфиденциально. Сообщения
									прочтёт психолог, который откликнется
									на&nbsp;заявку. Если
									ты&nbsp;не&nbsp;назовёшь себя,
									он&nbsp;не&nbsp;узнает, кто именно написал
									ему сообщение.
								</p>
							) : (
								''
